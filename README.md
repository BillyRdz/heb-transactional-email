...
**Link to project:** https://heb-transactional-email.netlify.app

![alt tag](https://billyrdz.com/wp-content/uploads/2022/05/heb-transactional-email2.gif)
...
The styling was written with SASS. I leveraged Gulp to compile the SASS, as well as minify images to make the Master HTML file nimble yet powerful.

The master index.html has everything compiled to inline HTML in order to work with all email clients.

## Lessons Learned:

- Pixel Perfect PSD to HTML & CSS
- How to set variables and @mixins for brand consistency
- How to set a JSON data file to easily manipulate data for email campaigns
- Creating proper table layouts for image and summary sections
- Writing reusable efficient code for minimal editing when A/B Testing
